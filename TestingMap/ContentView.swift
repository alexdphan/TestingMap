...
internal struct ContentView: View {
    ...
    public var body: some View {
        VStack {
            SwiftUIMapView(
                resourceOptions: ResourceOptions(accessToken: "pk.eyJ1IjoiYWxleGRwaGFuIiwiYSI6ImNrbDFwcW5zejA0ZjgydmwxZmFuYjdoaDAifQ.2mHRaXb_AKohWAutvfBbvw"),
...
@objc(SwiftUIExample)
internal class SwiftUIExample: UIViewController {
